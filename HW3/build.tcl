...
set files [list \
 ...
 [file normalize "$origin_dir/src/core_rtl/cache_prof.v" ]\
 [file normalize "$origin_dir/src/core_rtl/dcache_LRU.v" ]\
 [file normalize "$origin_dir/src/core_rtl/dcache_RAN.v" ]\
